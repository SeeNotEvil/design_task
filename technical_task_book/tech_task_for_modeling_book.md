...
Задача разработать дизайн и смоделировать волшебную книжку с фeнтезийной обложкой.
...
Главное, что бы внутренняя область рамки была неизменна и не уменьшалась в размерах.  
...
Рамку делаем более детализированной. Ниже примеры детализации.   
