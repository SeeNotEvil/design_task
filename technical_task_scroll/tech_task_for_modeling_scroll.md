...
5 - Наконечники - размеры подбираются индивидуально, около 3-6 (от трех до шести) см ширина каждого.         
...
#### Наконечники
Наконечники находятся на всех планках, по краям справа и слева. Их ширина добавляется к каждой планке сверх ее ширины, то есть 25 см + 3-6 (от трех до шести) см с каждой из сторон.   
...
На вверху верхней планки расположена небольшая фигура дракона. Дракон не перекрывает активную область свитка.      
